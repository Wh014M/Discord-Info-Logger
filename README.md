# Discord-Info-Logger
A free, efficient, and open-source discord token logger, that also grabs history, cookies, passwords, grabs computer data, and intercepts bitcoin addresses. This is purely for demonstration/educational purposes.
